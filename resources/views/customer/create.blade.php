...
<div class="container-fluid">
    ...
    <form action="{{ route('customer.store')}}" method="POST" class="d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="input-group">
            <input type="text" name="first_name" class="form-control bg-light border small" placeholder="Prénom" aria-label="Search" aria-describedby="basic-addon2">
        </div>
        <div class="input-group">
            <input type="text" name="last_name" class="form-control bg-light border small" placeholder="Nom" aria-label="Search" aria-describedby="basic-addon2">
        </div>
        <div class="input-group">
            <input type="email" name="email" class="form-control bg-light border small" placeholder="Email" aria-label="Search" aria-describedby="basic-addon2">
        </div>
        <div class="input-group">
            <input type="tel" name="phone_number" class="form-control bg-light border small" placeholder="Numéro de téléphone" aria-label="Search" aria-describedby="basic-addon2">
        </div>
        <div class="input-group">
